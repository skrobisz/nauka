...
$q = $db->prepare("SELECT LOGO_URL FROM `games`;");
$q->execute();
$result = $q->get_result();
$logoROWS = $result->fetch_all(MYSQLI_ASSOC);
foreach ($logoROWS as $ROWS) {
    echo $ROWS['LOGO_URL']."<br>";
}

//$image='<img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1172620/header.jpg?t=1714490015">';
//echo $image;
